    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="下单时间" prop="create_time" width="200px">
          <template v-slot="slotProps">{{slotProps.row.create_time*1000 | dateFormat}}</template>
        </el-table-column>
        <el-table-column label="操作" width="200px">
          <template v-slot="slotProps">
            <el-tooltip effect="dark" content="修改订单地址" placement="top">
              <el-button type="primary" icon="el-icon-edit" size="medium" @click="showBox"></el-button>
            </el-tooltip>
            <el-button
              type="success"
      ...
      <el-pagination
        ...
        :page-size="getOrderList.pagesize"
...
export default {
  ...
  methods: {
    ...
    async showProgressBox() {
      ...
      // }
      this.progressInfo = delivery.data;
